        ...
        axios
            ...
            .then((response) => {
                ...
                let lecTeams = data.filter(element =>
                    element?.slug === "flyquest"
                    || element?.slug === "evil-geniuses"
                    || element?.slug === "cloud9"
                    || element?.slug === "100-thieves"
                    || element?.slug === "tsm"
                    || element?.slug === "team-liquid"
                    || element?.slug === "immortals-progressive"
                    || element?.slug === "clg"
                    || element?.slug === "golden-guardians"
                    || element?.slug === "dignitas"
                );
                setResult(lecTeams);
            })
            .catch((error) => {
